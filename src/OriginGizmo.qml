...
Item {
    ...
    readonly property list<quaternion> rotations: [// +Z
        Qt.quaternion(1, 0,
                      0, 0), Qt.quaternion(Math.SQRT1_2, 0,
                                           0, -Math.SQRT1_2), Qt.quaternion(
            0, 0, 0, -1), Qt.quaternion(Math.SQRT1_2, 0, 0, Math.SQRT1_2), // -Z
        Qt.quaternion(0, 0,
                      -1, 0), Qt.quaternion(0, -Math.SQRT1_2,
                                            -Math.SQRT1_2, 0), Qt.quaternion(
            0, -1, 0, 0), Qt.quaternion(0, Math.SQRT1_2,
                                        -Math.SQRT1_2, 0), // +Y
        Qt.quaternion(0.5, 0.5,
                      0.5, 0.5), Qt.quaternion(Math.SQRT1_2, Math.SQRT1_2,
                                               0, 0), Qt.quaternion(
            -0.5, -0.5,
            0.5, 0.5), Qt.quaternion(0, 0, -Math.SQRT1_2, -Math.SQRT1_2), // -Y
        Qt.quaternion(0.5, -0.5, 0.5, -0.5), Qt.quaternion(
            0, 0, Math.SQRT1_2, -Math.SQRT1_2), Qt.quaternion(
            -0.5, 0.5, 0.5, -0.5), Qt.quaternion(-Math.SQRT1_2, Math.SQRT1_2,
                                                 0, 0), // +X
        Qt.quaternion(-0.5, -0.5,
                      0.5, -0.5), Qt.quaternion(-Math.SQRT1_2, 0,
                                                Math.SQRT1_2, 0), Qt.quaternion(
            -0.5, 0.5, 0.5, 0.5), Qt.quaternion(0, Math.SQRT1_2,
                                                0, Math.SQRT1_2), // -X
        Qt.quaternion(0, Math.SQRT1_2, 0, -Math.SQRT1_2), Qt.quaternion(
            0.5, -0.5,
            0.5, 0.5), Qt.quaternion(Math.SQRT1_2, 0,
                                     Math.SQRT1_2, 0), Qt.quaternion(0.5, 0.5,
                                                                     0.5, -0.5)]

    readonly property list<quaternion> xRotationGoals: [Qt.quaternion(
            0, 1, 0, 0), Qt.quaternion(0, 0, -1, 0), Qt.quaternion(
            0, -1, 0, 0), Qt.quaternion(0, 0, 1, 0), Qt.quaternion(
            0, -1, 0, 0), Qt.quaternion(0, 0, 1, 0), Qt.quaternion(
            0, 1, 0, 0), Qt.quaternion(0, 0, -1, 0), Qt.quaternion(
            0, 0, 1, 0), Qt.quaternion(0, 1, 0, 0), Qt.quaternion(
            0, 0, -1, 0), Qt.quaternion(-0, -1, -0, -0), Qt.quaternion(
            0, 0, -1, 0), Qt.quaternion(-0, -1, -0, -0), Qt.quaternion(
            0, 0, 1, 0), Qt.quaternion(-0, 1, -0, -0), Qt.quaternion(
            0, 0, 0, 1), Qt.quaternion(0, 0, 0, 1), Qt.quaternion(
            0, 0, 0, 1), Qt.quaternion(0, 0, 0, 1), Qt.quaternion(
            0, 0, 0, -1), Qt.quaternion(0, 0, 0, -1), Qt.quaternion(
            0, 0, 0, -1), Qt.quaternion(0, 0, 0, -1)]

    readonly property list<quaternion> yRotationGoals: [Qt.quaternion(
            0, 0, 1, 0), Qt.quaternion(0, 1, 0, 0), Qt.quaternion(
            0, 0, -1, 0), Qt.quaternion(0, -1, 0, 0), Qt.quaternion(
            0, 0, 1, 0), Qt.quaternion(0, 1, 0, 0), Qt.quaternion(
            0, 0, -1, 0), Qt.quaternion(0, -1, 0, 0), Qt.quaternion(
            ...
            0, 1, 0, 0), Qt.quaternion(0, 0, -1, 0), Qt.quaternion(
            0, 0, -1, 0), Qt.quaternion(0, -1, 0, 0), Qt.quaternion(
            0, 0, 1, 0), Qt.quaternion(0, 1, 0, 0)]

    readonly property list<quaternion> zRotationGoals: [Qt.quaternion(
            0, 0, 0, 1), Qt.quaternion(0, 0, 0, 1), Qt.quaternion(
            0, 0, 0, 1), Qt.quaternion(0, 0, 0, 1), Qt.quaternion(
            0, 0, 0, -1), Qt.quaternion(0, 0, 0, -1), Qt.quaternion(
            0, 0, 0, -1), Qt.quaternion(0, 0, 0, -1), Qt.quaternion(
    ...
    function findClosestRotation(rotation, startI, stopI) {
        ...
        let xRotated = rotation.times(Qt.quaternion(0, 1, 0, 0)).times(
                rotationConjugated)
        let yRotated = rotation.times(Qt.quaternion(0, 0, 1, 0)).times(
                rotationConjugated)
        let zRotated = rotation.times(Qt.quaternion(0, 0, 0, 1)).times(
                rotationConjugated)

        var closestIndex = 0
        var closestDistance = 123456789
    ...
    function quaternionForAxis(axis, rotation) {
        let closestIndex = findClosestRotation(rotation, axis * 4,
                                               (axis + 1) * 4)
        return rotations[closestIndex]
    }
    ...
    component LineRectangle: Rectangle {
        ...
        rotation: Math.atan2(endPoint.y - startPoint.y,
    ...
    Rectangle {
        ...
        Item {
            ...
            component SubBall: Rectangle {
                ...
                readonly property vector3d position: quaternionVectorMultiply(
                                                         targetNode.rotation,
                                                         initialPosition)
            ...
            LineRectangle {
                endPoint: Qt.vector2d(
                              positiveX.x + ballBackground.subBallHalfWidth,
                              positiveX.y + ballBackground.subBallHalfWidth)
                color: stylePalette.red
                z: positiveX.z - 0.001
            }
            ...
            LineRectangle {
                endPoint: Qt.vector2d(
                              positiveY.x + ballBackground.subBallHalfWidth,
            ...
            LineRectangle {
                endPoint: Qt.vector2d(
                              positiveZ.x + ballBackground.subBallHalfWidth,
            ...
            SubBall {
                ...
                color: Qt.rgba(stylePalette.red.r, stylePalette.red.g,
                               stylePalette.red.b, z + 1 * 0.5)
            ...
            SubBall {
                ...
                labelColor: stylePalette.white
                labelVisible: hovered
                color: Qt.rgba(stylePalette.green.r, stylePalette.green.g,
                               stylePalette.green.b, z + 1 * 0.5)
            ...
            SubBall {
                ...
                labelColor: stylePalette.white
                labelVisible: hovered
                color: Qt.rgba(stylePalette.blue.r, stylePalette.blue.g,
                               stylePalette.blue.b, z + 1 * 0.5)
